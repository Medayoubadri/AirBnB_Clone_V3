...
This project is an extension of the AirBnB clone, integrating RESTful API functionalities.
...
This project is interpreted/tested on Ubuntu 21.04 LTS using python3 (version 3.4.3)
...
- `all` - Prints all string representations of all instances based on or not on the class name.
...
Mohamed Ayoub Badri - [Github](https://github.com/medayoubadri) / [Twitter](https://twitter.com/medayoubadri)
